    ...
    <div className="w-full">
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <h2>Visão Global</h2>
          <p className="mt-4">
            Pokédex usando NextJs e Tailwind CSS para acessar endpoints de uma
            API, Neste projeto foi aprendido sobre geração de site estático,
            renderização do lado do servidor, rotas dinâmicas, buscar API e
            muito mais. Este aplicativo é o primeiro projeto NextJS, e foi
            utilizado a API pikaserve do GitHub.
          </p>
          <a
            href="https://nextpokedex-app.netlify.app/"
            target="_blank"
            rel="noreferrer"
          >
            <button className="px-8 py-2 mr-8 mt-4 dark:shadow-none">
              Demonstração
            </button>
          </a>
          <a
            href="https://github.com/pauloaraujo028/nextjs-pokedex"
            target="_blank"
            rel="noreferrer"
          >
