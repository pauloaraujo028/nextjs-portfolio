      ...
      <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
        <div className='col-span-2'>
          ...
          <p className='py-2 text-gray-600'>
            ...
            atenção e após alguns meses de estudo conheci o ReactJs no qual resolvi
            me dedicar e estudarei até me tornar um profissional experiente na linguagem.
            Comecei com básico do HTML e CSS para fazer alguns pequenos projetos,
            O que eu achava que eram apenas algumas pequenas edições se transformaram
            em amor pelo front-end.
          </p>
          <p className='py-2 text-gray-600'>
            ...
            agora estou passando meu tempo construindo projetos com React JS,
