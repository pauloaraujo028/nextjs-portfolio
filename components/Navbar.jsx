...
const Navbar = () => {
  ...
  useEffect(() => {
    if (
      router.asPath === "/eshop" ||
      router.asPath === "/multihome" ||
      router.asPath === "/criptobase" ||
      //router.asPath === "/bestfood" ||
    ...
    >
      <div className="flex justify-between items-center w-full h-full px-2 2xl:px-16 dark:bg-[#2d3748]">
        ...
        <div className="items-center justify-center hidden md:flex">
          {renderThemeChanger()}
          <button className="w-full p-[5px] text-gray-100 capitalize ml-2 dark:shadow-none lg:text-base md:text-xs">
        ...
        >
          <div>
            <div className="flex w-full items-center justify-between">
              <Link href="/">
                <a>
                  <Image src={NavLogo} width="87" height="70" alt="/" />
                </a>
              </Link>
              <div
                onClick={handleNav}
            ...
            <div className="border-b border-gray-300 my-2">
              <p className="w-[85%] md:w-[90%] py-2 dark:text-[#fff]">
          ...
          <div className="py-4 flex flex-col dark:text-[#fff]">
            ...
            <div className="flex items-center justify-center">
              {renderThemeChanger()}
              <button className="w-full p-2 m-8 text-gray-100 capitalize dark:shadow-none">
                <a href="/Resumo.pdf" download={true}>
                  Baixar CV
                </a>
              </button>
