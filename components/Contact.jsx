    ...
    <div id="contact" className="w-full lg:h-screen">
      <div className="max-w-[1240px] m-auto px-2 py-16 w-full">
        ...
        <div className="grid lg:grid-cols-5 gap-8">
          {/* letf */}
          <div className="col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-gray-400 rounded-xl p-4 dark:border dark:shadow-none">
            <div className="lg:p-4 h-full">
              ...
              <div className="pt-20">
                <p className="uppercase pt-8 text-[#fe140d]">
                  Conecte-se Comigo
                </p>
          ...
          {/* right */}
          <div className="col-span-3 w-full h-auto shadow-xl shadow-gray-400 rounded-xl lg:p-4 dark:border dark:shadow-none">
            <div className="p-4">
              <form
                action="https://getform.io/f/59b42533-1a84-456b-ae7d-29a5b914eb98"
                method="POST"
              >
        ...
        <div className="flex justify-center py-12">
          <Link href="/">
            <div className="rounded-full shadow-lg shadow-gray-400 p-4 cursor-pointer hover:scale-110 ease-in duration-300 dark:bg-white dark:text-black dark:border dark:shadow-none">
      ...
      <footer className="flex justify-center items-center font-bold">
        <p className="text-center">
          © {year} Paulo Araújo. Todos os direitos reservados.
        </p>
      </footer>
    </div>
  );
